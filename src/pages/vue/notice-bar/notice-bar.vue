<template>
  <view class="container">
    ...
    <uni-section
      title="显示图标"
      sub-title="使用 show-icon 属性显示左侧小喇叭图标"
      type="line"
    >
      <uni-notice-bar
        show-icon
    ...
    <uni-section
      title="文字滚动"
      sub-title="使用 scrollable 属性使通告滚动,此时 single 属性将失效,始终单行显示"
      type="line"
    >
      <uni-notice-bar
        show-icon
    ...
    <uni-section
      title="查看更多"
      sub-title="使用 show-get-more 显示更多,此时 single 属性将失效,始终单行显示,如不配置 more-text 属性 ,将显示箭头图标"
      type="line"
    >
      <uni-notice-bar
        show-get-more
    ...
    <uni-section
      title="关闭按钮"
      sub-title="使用 show-close 属性,可关闭通知"
      type="line"
    >
      <uni-notice-bar
        show-close
