<template>
  <view>
    ...
    <uni-section
      title="最大最小值"
      sub-title="使用 min / max 设置多选的最大最小值,单选无效"
    >
      <view class="uni-px-5 uni-pb-5">
        <view class="text">
    ...
    <uni-section
      title="更多样式 - button"
      sub-title="使用mode=button属性使用按钮样式"
      type="line"
    >
      <view class="uni-px-5">
        <view class="text">
    ...
    <uni-section
      title="禁用"
      sub-title="数据中使用 disable 属性实现单独禁用,组件使用 disable 属性实现全部禁用"
      type="line"
    >
      <view class="uni-px-5">
        <view class="text">
    ...
    <uni-section
      title="自定义高亮颜色"
      sub-title="使用 selectedColor 属性修改颜色"
      type="line"
    >
      <view class="uni-px-5">
        <view class="text">
