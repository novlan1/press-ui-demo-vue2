...
<script>
import PressMessageBoardInput from 'packages/press-ui/packages/press-message-board/press-message-board-input.vue';
import PressMessageBoardList from 'packages/press-ui/packages/press-message-board/press-message-board-list.vue';
import PressMessageBoardItem from 'packages/press-ui/packages/press-message-board/press-message-board-item.vue';
...
<style  lang="scss">
@import "packages/press-ui/packages/base/mixin.scss";
.demo-list-wrap {
  padding: 0 20px;
}
.demo-input-wrap {
