...
<script>
import PressMessageBoardInput from 'packages/set-ui/packages/press-message-board/press-message-board-input.vue';
import PressMessageBoardList from 'packages/set-ui/packages/press-message-board/press-message-board-list.vue';
import PressMessageBoardItem from 'packages/set-ui/packages/press-message-board/press-message-board-item.vue';
...
<style  lang="scss">
@import "packages/set-ui/packages/base/mixin.scss";
.demo-list-wrap {
  padding: 0 20px;
}
.demo-input-wrap {
