<template>
  <view class="content">
    ...
    <view class="box black uni-mt-2">
      black
    </view>
    <view class="box main-color uni-mt-2">
      main-color
    </view>
    <view class="box base-color uni-mt-2">
      base-color
    </view>
    <view class="box secondary-color uni-mt-2">
      secondary-color
    </view>
    <view class="box light-color uni-mt-2">
      light-color
    </view>
    <view class="box border-1 uni-mt-2">
      border-1
    </view>
    <view class="box border-2 uni-mt-2">
      border-2
    </view>
    <view class="box border-3 uni-mt-2">
      border-3
    </view>
    <view class="box border-4 uni-mt-2">
      border-4
    </view>
    <view class="box bg-color uni-mt-2">
      bg-color
    </view>
    <view class="box white uni-mt-2">
      white
    </view>
    <view class="box transparent uni-mt-2">
      transparent
    </view>
  </view>
</template>
