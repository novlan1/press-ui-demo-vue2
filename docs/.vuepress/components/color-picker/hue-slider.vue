<template>
  <div class="press-color-hue-slider" :class="{ 'is-vertical': vertical }">
    <div class="press-color-hue-slider__bar" @click="handleClick" ref="bar"></div>
    <div class="press-color-hue-slider__thumb"
         :style="{
           left: thumbLeft + 'px',
           top: thumbTop + 'px'
         }"
